...
bool KeyboardCue::operator()(Keyboard const& kb) const
{
...
bool MouseCue::operator()(Mouse const& m) const
{
...
bool MouseCue::operator()(Mouse const& m, Keyboard const& kb) const
{
